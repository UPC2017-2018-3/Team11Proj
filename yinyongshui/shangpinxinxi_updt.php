...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"> 
      ...
      <tr><td>商品编号：</td><td><input name='shangpinbianhao' type='text' id='shangpinbianhao' value='<?php echo mysql_result($query,$i,shangpinbianhao);?>' /></td></tr><tr><td>商品名称：</td><td><input name='shangpinmingcheng' type='text' id='shangpinmingcheng' size='50' value='<?php echo mysql_result($query,$i,shangpinmingcheng);?>' /></td></tr><tr><td>规格：</td><td><input name='guige' type='text' id='guige' size='50' value='<?php echo mysql_result($query,$i,guige);?>' /></td></tr><tr><td>产地：</td><td><input name='chandi' type='text' id='chandi' value='<?php echo mysql_result($query,$i,chandi);?>' /></td></tr><tr><td>保质期：</td><td><input name='baozhiqi' type='text' id='baozhiqi' value='<?php echo mysql_result($query,$i,baozhiqi);?>' /></td></tr><tr><td>备注：</td><td><textarea name='beizhu' cols='50' rows='8' id='beizhu'><?php echo mysql_result($query,$i,beizhu);?></textarea></td></tr>
