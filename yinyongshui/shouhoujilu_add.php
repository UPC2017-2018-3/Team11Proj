...
if ($addnew=="1" )
{
	...
	mysql_query($sql);
	echo "<script>javascript:alert('添加成功!');location.href='shouhoujilu_add.php';</script>";
}
?>
...
<body>
<p>添加售后记录： 当前日期： <?php echo $ndate; ?></p>
<script language="javascript">
	function check()
{
	if(document.form1.danjubianhao.value==""){alert("请输入单据编号");document.form1.danjubianhao.focus();return false;}if(document.form1.shangpinmingcheng.value==""){alert("请输入商品名称");document.form1.shangpinmingcheng.focus();return false;}if(document.form1.kehuxingming.value==""){alert("请输入客户姓名");document.form1.kehuxingming.focus();return false;}if(document.form1.kehudianhua.value==""){alert("请输入客户电话");document.form1.kehudianhua.focus();return false;}
}
	function gow()
	{
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">    
	<tr><td>单据编号：</td><td><select name='danjubianhao' id='danjubianhao' onchange='gow();'><?php getoption2("xiaoshoudan","danjubianhao")?></select></td></tr><tr><td>商品名称：</td><td><input name='shangpinmingcheng' type='text' id='shangpinmingcheng' <?php getitem("xiaoshoudan","shangpinmingcheng","danjubianhao",$_GET["danjubianhao"])?> />&nbsp;*</td></tr><tr><td>客户姓名：</td><td><input name='kehuxingming' type='text' id='kehuxingming' value='' />&nbsp;*</td></tr><tr><td>客户电话：</td><td><input name='kehudianhua' type='text' id='kehudianhua' value='' />&nbsp;*</td></tr><tr><td>售后要求：</td><td><textarea name='shouhouyaoqiu' cols='50' rows='8' id='shouhouyaoqiu'></textarea></td></tr><tr><td>服务内容：</td><td><textarea name='fuwuneirong' cols='50' rows='8' id='fuwuneirong'></textarea></td></tr><tr><td>备注：</td><td><textarea name='beizhu' cols='50' rows='8' id='beizhu'></textarea></td></tr>
